        ...
        <div id="topSalesCarousel" class="carousel slide">
            <div class="carousel-inner">
                ...
                foreach($product_shuffle as $item) :
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a href="<?php printf('%s?item_id=%s', 'view/product.view.php', $item['item_id']); ?>"><img src="<?php echo $item['item_image'] ?? 'default_image.jpg'; ?>" class="card-img-top" alt="Product Image"></a>
                            <div class="card-body">
